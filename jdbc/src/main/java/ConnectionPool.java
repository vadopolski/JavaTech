...
public class ConnectionPool {
    ...
    public ConnectionPool(BlockingQueue<Connection> connectionQueue) throws ConnectionPoolException {
    ...
    public void initPoolData() throws ConnectionPoolException {
        ...
        try {
            ...
            throw new ConnectionPoolException("SQLException in ConnectionPoool", e1);
        }
        catch (ClassNotFoundException e2) {
            throw new ConnectionPoolException("Can't find database driver class", e2);
        }
    ...
    private class PooledConnection implements Connection {
        ...
        @Override public Statement createStatement(int i, int i1) throws SQLException {
            return connection.createStatement(i, i1);
        }

        @Override public PreparedStatement prepareStatement(String s, int i, int i1) throws SQLException {
            return connection.prepareStatement(s, i, i1);
        }

        @Override public CallableStatement prepareCall(String s, int i, int i1) throws SQLException {
        ...
        @Override public void setHoldability(int i) throws SQLException {
        ...
        @Override public Savepoint setSavepoint(String s) throws SQLException {
        ...
        @Override public Statement createStatement(int i, int i1, int i2) throws SQLException {
            return connection.createStatement(i, i1, i2);
        }

        @Override public PreparedStatement prepareStatement(String s, int i, int i1, int i2) throws SQLException {
            return connection.prepareStatement(s, i, i1, i2);
        }

        @Override public CallableStatement prepareCall(String s, int i, int i1, int i2) throws SQLException {
            return connection.prepareCall(s, i, i1, i2);
        }

        @Override public PreparedStatement prepareStatement(String s, int i) throws SQLException {
            return connection.prepareStatement(s, i);
        }

        @Override public PreparedStatement prepareStatement(String s, int[] ints) throws SQLException {
            return connection.prepareStatement(s, ints);
        }

        @Override public PreparedStatement prepareStatement(String s, String[] strings) throws SQLException {
        ...
        @Override public PreparedStatement prepareStatement(String s) throws SQLException {
            return connection.prepareStatement(s);
        }

        @Override public CallableStatement prepareCall(String s) throws SQLException {
            return connection.prepareCall(s);
        }

        @Override public String nativeSQL(String s) throws SQLException {
